...
route.get('/history',isAuthenticated, hasRole(['admin', 'comptable', 'utilisateur']), orderedController.getOrderedHistory);
route.get('/monthly', isAuthenticated, hasRole(['admin', 'comptable']), orderedController.getOrderedHistory)
